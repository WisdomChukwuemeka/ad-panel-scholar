  ...
  try {
    ...
    return(
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <input type="checkbox" id="is_scholar" name="is_scholar" checked={formData.is_scholar} onChange={handleChange} className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
            ...
            <div className="flex items-center">
                ...
                <label htmlFor="agreement" className="text ml-2 block  text-gray-900">I agree to the <a href="#" className="text-blue-600 hover:text-blue-500">Terms and Conditions</a></label>
            </div>
            <div>
